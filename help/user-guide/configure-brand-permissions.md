...
1. Klik op **[!UICONTROL Save]**. De Admin Console opent _Nieuwe groep_ popup, met de naam van de pas gecreëerde groep.
...
1. Navigeer aan het _lusje van de Opslag_ in de Admin Console.
