...
>[!NOTE]
>
>Als de richtsnoeren in _Parameters_ in de herinnering lade worden toegevoegd, te hoeven u niet om verwijzing naar hen in uw herinnering te omvatten. GenStudio for Performance Marketing maakt automatisch gebruik van de methoden voor het genereren van inhoud.
...
Zie [&#x200B; beste praktijken voor het gebruiken van malplaatjes &#x200B;](/help/user-guide/templates/best-practices-for-templates.md).
