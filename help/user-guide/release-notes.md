...
* Nieuwe filteropties voor sjablonen! U kunt de lijst met _[!UICONTROL Select templates]_&#x200B;nu verfijnen in [!DNL Create] en in&#x200B;_[!UICONTROL Content]_ > _[!UICONTROL Templates]_. Zie [&#x200B; malplaatjes van het Onderzoek &#x200B;](/help/user-guide/templates/use-templates.md#search-templates). Zorg ervoor dat sjablonen correct zijn gecodeerd met metagegevens, zodat deze kunnen worden gedetecteerd via deze filters.
