...
E-mailsjablonen met meerdere secties kunnen uit maximaal 10 secties bestaan:
...
- Een complexe sjabloon (meerdere secties) kan sets sjabloonelementen genereren, waarvoor u de naamgevingsconventie voor groepen moet volgen: `<groupname_fieldname>` .
