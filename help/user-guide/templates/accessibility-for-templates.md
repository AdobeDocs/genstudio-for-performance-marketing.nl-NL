...
- [ Alternatieve tekst ](/help/user-guide/templates/customize-template.md#alternative-text)
- [ etiket van de Toegankelijkheid ](/help/user-guide/templates/customize-template.md#accessibility-label)
