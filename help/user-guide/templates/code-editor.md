...
Het deelvenster _[!UICONTROL Check detected fields]_wordt bijgewerkt met de wijzigingen die u hebt aangebracht. Zodra u wordt tevreden dat de gebieden correct en volledig zijn, klik **[!UICONTROL Next]**om [ te blijven uploaden uw malplaatje ](/help/user-guide/templates/use-templates.md#add-a-template).
