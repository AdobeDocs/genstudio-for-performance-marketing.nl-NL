...
Elk sjabloontype gebruikt verschillende elementen om een structuur te maken voor het maken van kanaalspecifieke inhoud. [Verken zich met de delen van een malplaatje ](use-templates.md#template-elements) en omvat de beste elementen voor uw inhoud en malplaatjetype.
