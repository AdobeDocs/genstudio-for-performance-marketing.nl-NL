---
title: Overzicht van kanaalrichtlijnen
description: Voeg kanaalrichtlijnen toe aan GenStudio for Performance Marketing om een uitgebreid merkprofiel te maken dat alle aspecten van de weergave van een merk omvat.
level: Beginner
...
GenStudio for Performance Marketing-richtlijnen kunnen worden geüpload of handmatig aan GenStudio for Performance Marketing worden toegevoegd, zodat gebruikers merkrichtlijnen kunnen opstellen die de essentie van de identiteit van een merk weergeven.
...
* Door de gebruiker gedefinieerde richtlijnen (zoals [!DNL Brands] , [!DNL Products] en [!DNL Personas] )
...
Zie [ richtlijnen ](/help/user-guide/guidelines/add-guidelines.md) toevoegen om te leren hoe te om elk type toe te voegen.
...
De kanaalrichtlijnen laten twee belangrijke gebruiksgevallen toe om ervoor te zorgen dat om het even welke geproduceerde inhoud aan de gewenste vertegenwoordiging van een merk voldoet:
...
Samen met de generatieve AI-functionaliteit van Adobe spelen [!DNL Brands] , [!DNL Products] en [!DNL Personas] een cruciale rol bij het afstemmen van al uw GenStudio for Performance Marketing-inhoud op uw merkidentiteit.
