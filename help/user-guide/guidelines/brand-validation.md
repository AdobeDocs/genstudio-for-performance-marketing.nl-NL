...
description: Meer informatie over het ingebouwde merkvalidatiesysteem in GenStudio for Performance Marketing.
...
* [ de steun van de Toegankelijkheid ](/help/user-guide/guidelines/brand-validation.md#supporting-your-accessibility-strategy)
...
1. Na het aanbrengen van noodzakelijke revisies, klik **[!UICONTROL Recheck score]** om uw veranderingen opnieuw te controleren en te bevestigen om ervoor te zorgen zij met uw merkidentiteit, platformrichtlijnen, en toegankelijkheidsnormen worden gericht.
...
## De toegankelijkheidsstrategie ondersteunen

GenStudio for Performance Marketing bevat inhoudscontroles die zijn ontworpen om klanten te helpen hun eigen best practices voor toegankelijkheid te ondersteunen.

Deze functie omvat de volgende inhoudscontroles:

* Afbeeldingen bevatten een `<alt>` -kenmerk.
* De geproduceerde tekst heeft 4.5 :1 contrast tegen zijn achtergrond.
* Woorden of zinsdelen die op ongebruikelijke of beperkte wijze worden gebruikt, met inbegrip van idiomen en jargon, worden vermeden.
* Uitgebreide vormen of betekenis van afkortingen zijn beschikbaar.
* Inhoud is leesbaar op een lager niveau van secundair onderwijs.

Klanten worden aangemoedigd om deze functies te gebruiken als onderdeel van hun bredere toegankelijkheidsstrategie, maar klanten blijven verantwoordelijk voor hun eigen wettelijke en toegankelijkheidsvereisten.
